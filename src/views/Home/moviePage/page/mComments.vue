...
<div>
    ...
    <div class="commentBlock" v-for="(item,index) in mComments" :key="index">
        <div class="userInfo">
    ...
    <sendBar @sendMcomment="sendMcomment"></sendBar>
    <div class="ac">{{ac}}</div>
  </div>
</template>
...
　　    }
    ...
    computed:{
        mComments:{
            get(){
                return this.$store.state.movieDataAll.comments
            },
            set(val){
                this.$store.state.movieDataAll.comments = val
